...
public class MixedRealityTutorial : MonoBehaviour
{
    static public MixedRealityTutorial Instance = null;
    ...
    void AttachToView(bool doAttach)
    {
        ...
        if (MixedRealityManager.Instance)
        {
            MixedRealityManager.Instance._fadeSphere.sharedMaterial.renderQueue = doAttach ? 4497 : 4999;
        }
    }

    void UpdatePosition(bool useSmoothing = true)
    {
        Transform centerEye = MixedRealityManager.Instance._mainCamera.transform;
