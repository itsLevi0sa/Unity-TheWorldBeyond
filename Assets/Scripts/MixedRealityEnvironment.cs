...
public class MixedRealityEnvironment : MonoBehaviour
{
    static public MixedRealityEnvironment Instance = null;
    ...
    void SpawnObjectsWithMap()
    {
        ...
        for (int x = 0; x < _cells; x++)
        {
            for (int y = 0; y < _cells; y++)
            {
                ...
                Vector3 desiredPosition = cellCenter + randomOffset + MixedRealityManager.Instance.GetFloorHeight() * Vector3.up;
